                        ...
                        <form action="upload.php" method="post" enctype="multipart/form-data">
                            ...
                            <div class="input-group justify-content-center">
                                <div class="input-group-prepend">
                                    <span class="input-group-text t_input_txt tat-label">Project Image: </span>
                                </div>
                            ...
                            <div class="input-group justify-content-center">
                                <div class="input-group-prepend">
                                    <span class="input-group-text t_input_txt tat-label">Project Files: </span>
                                </div>
                                <input multiple type="file" class="t_input_txt form-control-file form-control-lg border tat-file_input" name="p_files_to_upload[]" id="p_files_to_upload">
                            </div>
                            <input type="text" class="t_input_txt form-control form-control-lg" placeholder="database name (games/simulations/projects)" name="db_name" value="">
                            <input type="text" class="t_input_txt form-control form-control-lg" placeholder="item name (ex: Snake)" name="item_name" value="">
                            <input type="text" class="t_input_txt form-control form-control-lg" placeholder="item directory (ex: snake)" name="item_link" value="">
                            <input type="submit" id="my_submit" class="t_input_submit form-control-lg" value="Upload Item" name="submit">
                        </form>
                    <?} else {?>
